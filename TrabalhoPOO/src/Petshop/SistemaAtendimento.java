...
public class SistemaAtendimento implements Crud{
    ...
    /**
     * Construtor da classe SistemaAtendimento
     * Inicializa a lista de atendimentos, o input para leitura de dados, 
     * o sistemaCliente, o sistemaFuncionario e sistemaAnimal
     * 
     * @param input O objeto Scanner utilizado para ler a entrada do usuário.
     * @param sistemaCliente O objeto SistemaCliente utilizado para gerenciamento dos clientes
     * @param sistemaFuncionario O objeto SistemaFuncionario utilizado para gerenciamento dos funcionarios
     * @param sistemaAnimal O objeto SistemaAnimal utilizado para gerencimando dos animais
     */
    ...
    /**
     * Pede para o usuario informar um cpf e verifica se ja existe um cliente cadastrado com esse cpf
     * caso houver: retorna o cliente, caso contrário, redireciona o usuário para o cadastro de cliente
     * 
    ...
    /**
     * Pede para o usuario informar um numero de matricula e verifica se ja existe um funcionario cadastrado
     * com esse numero de matricula. Caso houver: retorna o funcionario, caso contrário, redireciona o usuário 
     * para o cadastro de funcionario
     * 
    ...
    /**
     * Pede para o usuario informar um id e verifica se ja existe um animal cadastrado com esse id
     * caso houver: retorna o animal, caso contrário, redireciona o usuário para o cadastro de animal
     * 
    ...
    /**
    * Cadastra um novo atendimento no sistema e insere na lista de atendimentos.
    */
	@Override
    ...
    /**
     * Verifica se um atendimento está cadastrado pelo codigo e, se estiver, exibe
     * suas informacoes.
     */
    @Override
    ...
    /**
     * Exibe um menu de opcoes com as informacoes do atendimento e pede para o usuario digitar
    ...
    /**
     * Realiza a alteracao do cliente do atendimento.
     * Caso exista um cliente cadastrado com o cpf informado, é realizada
     * a alteracao. Caso contrario o usuario pode ser redirecionado para o
    ...
    /**
     * Realiza a alteracao do funcionario do atendimento.
     * Caso exista um funcionario cadastrado com o numero de matricula informado, 
     * é realizada a alteracao. Caso contrario o usuario pode ser redirecionado
     * para o cadastro de funcionario ou cancelar a alteracao
     * 
    ...
    /**
     * Realiza a alteracao do ani aldo atendimento.
     * Caso exista um animal cadastrado com o id informado, é realizada
     * a alteracao. Caso contrario o usuario pode ser redirecionado
     * para o cadastro de animal ou cancelar a alteracao
     * 
    ...
    /**
     * Realiza a alteracao de algum dado do atendimento, caso o atendimento exista.
     */
    @Override
    public void alterar(){
        int opcao, codigo;
    ...
    /**
     * Realiza uma busca sequencial pela lista de atendimentos para encontrar o atendimento
     * que possui o mesmo codigo que o codigo buscado.
     * 
     * @param codigo codigo do atendimento a ser encontrado.
     * 
     * @return Atendimento caso encontre o atendimento, caso contrario retorna null.
     */
    ...
    /**
     * Realiza uma busca sequencial pela lista de atendimentos para encontrar pelo menos
     * um atendimento que possua um funcionario com o numero de matricula correspondente
     * ao numero de matricula buscado.
     * 
    ...
    /**
     * Realiza uma busca sequencial pela lista de atendimentos para encontrar o animal
     * que possui o mesmo id que o id o buscado.
     * 
    ...
    /**
     * Realiza uma busca sequencial pela lista de atendimentos para encontrar o cliente
     * que possui o mesmo cpf que o cpf o buscado.
     * 
