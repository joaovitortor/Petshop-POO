...
public class SistemaCliente implements Crud {
     ...
     * 
     * @param sistemaAnimal sistemaAnimal a ser incializado
     */
    ...
    /**
     * Verifica se um cliente está cadastrado pelo cpf e, se estiver, exibe suas
     * informacoes
     */
    @Override
    ...
    /**
     * Exibe um menu de opcoes com as informacoes do cliente e pede para o
    ...
    /**
     * Remove um cliente do sistema caso ele nao esteja vinculado a pelo menos
     * um atendimento ou animal.
     */
    @Override
    public void remover() {
        Cliente cliente;
    ...
    /**
     * Realiza uma busca sequencial pela lista de clientes para encontrar o
     * cliente que possui o mesmo cpf que o cpf buscado.
     *
